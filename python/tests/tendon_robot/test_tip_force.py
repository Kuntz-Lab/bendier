...
def run_sim(params, do_baseline, plot):
    ...
    solver_baseline = Benchmark(solver_config, dummy_solution.marginals.tendon_config.hole_locations)
    ...
    plotter_post = TendonRobotPlotter(
